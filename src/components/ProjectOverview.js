  ...
  return (
    <div className="project-overview">
      ...
      <div className="hero-section">
        ...
        <p>
          Revolutionizing industrial design with transparency,
      ...
      <section className="core-focus">
        ...
        <div className="focus-grid">
          <div className="focus-card">
            ...
            <p>
              Advanced automation and data-driven design for smarter,
              interconnected, and self-optimizing plants.
            </p>
          </div>
          ...
          <div className="focus-card">
            ...
            <p>
              Equipment and processes engineered to minimize environmental
              impact and maximize energy conservation.
            </p>
          </div>
          ...
          <div className="focus-card">
            ...
            <p>
              Blockchain-backed traceability and ownership for trusted
      ...
      <section className="industry-focus">
        ...
        <div className="industry-grid">
          <div className="industry-card">
            <h3>Refinery</h3>
            <p>
              Front-end design to commissioning—efficient crude-to-product
              workflows with robust safety margins.
            </p>
          </div>
          ...
          <div className="industry-card">
            <h3>Pharma</h3>
            <p>
              cGMP-aligned equipment and process design for quality,
          ...
          <div className="industry-card">
            <h3>Environment</h3>
            <p>
              Water treatment, waste management, and renewable integration
      ...
      <section className="cta-section">
        ...
        <div className="cta-buttons">
          ...
          <a
            href="/assets/whitepaper_Engineering_Drawing.pdf"
            download
